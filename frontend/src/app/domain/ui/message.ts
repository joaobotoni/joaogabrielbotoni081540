...
export const success = (message: string): Message => ({
    message: message,
    type: 'success',
...
export const warning = (message: string): Message => ({
    message: message,
    backColor: 'bg-amber-50',
    textColor: 'text-amber-800',
    iconColor: 'text-amber-400',
    iconPath: 'M8.485 3.495c.673-1.167 2.357-1.167 3.03 0l6.28 10.875c.673 1.167-.17 2.625-1.516 2.625H3.72c-1.347 0-2.189-1.458-1.515-2.625l6.28-10.875zM10 6a.75.75 0 01.75.75v3.5a.75.75 0 01-1.5 0v-3.5A.75.75 0 0110 6zm0 9a1 1 0 100-2 1 1 0 000 2z'
})